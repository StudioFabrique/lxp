const LessonsPreviewSkeleton = () => {
  return (
    <div className="px-8 p-4">
      {/* Header Skeleton */}
      <div className="w-full h-48 relative skeleton bg-base-200 rounded-xl">
      ...
      <div className="mt-5 max-xl:flex max-xl:flex-col-reverse xl:grid xl:grid-cols-4 gap-5 w-full">
        ...
        <div className="w-full h-[600px] skeleton bg-base-200 rounded-xl p-4">
          ...
          <div className="space-y-4">
            {[1, 2, 3].map((i) => (
              <div key={i} className="space-y-2">
                <div className="h-24 w-full skeleton bg-base-300 rounded-xl" />
        ...
        <div className="flex flex-col gap-5 xl:col-span-3">
          ...
          <div className="h-20 w-full skeleton bg-base-200 rounded-xl" />
          ...
          <div className="space-y-4">
            ...
            {[1, 2].map((i) => (
              <div
                key={i}
                className="h-48 w-full skeleton bg-base-200 rounded-xl p-4"
              >
                <div className="space-y-4">
