...
const VirtualClass = (props: VirtualClassProps) => {
  ...
  return (
    <div
      className="w-full flex items-center gap-x-4 tooltip tooltip-top"
      data-tip="Si vous gérez une classe virtuelle sur Zoom, Google meet, Teams … vous pouvez saisir le lien ici."
    >
