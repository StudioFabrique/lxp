...
const Resources = ({ currentRoute }: { currentRoute: string[] }) => {
  // Vérifie si la route actuelle correspond à la médiathèque
  const isCurrentPathActive = currentRoute[1] === "resources";

  return (
    <li>
      {/* Lien vers la page médiathèque */}
      <Link
        to={`/${currentRoute[0]}/resources`}
      ...
      >
        ...
        <div className="tooltip w-6 h-6" data-tip="Ressources supplémentaires">
          ...
          <div className="flex hover justify-center items-center">
            ...
            <Boxes className="z-10 pointer-events-none" />
