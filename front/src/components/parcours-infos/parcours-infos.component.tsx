    ...
    <div className="flex flex-col gap-y-4 p-4 rounded-lg bg-secondary/20">
      ...
      <form className="flex flex-col gap-y-4">
        <div className="flex flex-col gap-y-1">
          ...
          <input className="input w-full" name="title" type="text" />
        </div>
        <div className="flex flex-col gap-y-1">
        ...
        <div className="flex flex-col gap-y-1">
          ...
          <input className="input w-full" name="degree" type="text" />
        </div>
        <div className="flex flex-col gap-y-1">
          <label htmlFor="fileToUpload">Téléverser une image</label>
          <input
            type="file"
            className="file-input file-input-neutral w-full bg-secondary/10 rounded-lg"
          />
        </div>
      </form>
    </div>
