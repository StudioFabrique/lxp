...
docker cp lxp-mongo:/dump-mongo ./dumps/ || { echo -e "\033[1;31m ❌ Échec: Copie du dump MongoDB"; exit 1; }
...
echo -e "\033[1;32m Les données ont été sauvegardées avec succès dans le dossier ./dumps/ \033[0m"
